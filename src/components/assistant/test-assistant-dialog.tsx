              ...
              >
                ...
                >
                    ...
                    >
                     ...
                     {msg.role === 'assistant' && isAISpeaking && chatHistory.some(m => m.id === msg.id && !m.isThinking && !m.isSynthesizing) && currentAudioRef.current && !currentAudioRef.current.paused && currentAudioRef.current.src.length > 0 && (
